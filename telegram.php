...
class Telegram {
    ...
    public function sendMessage($chat_id, $text, $reply_markup=null, $parse_mode=null, $business_connection_id = null, $entities = null) {
        return $this->bot('sendMessage', [
            'chat_id' => $chat_id,
            'text' => $text,
            'reply_markup' => $reply_markup ? json_encode($reply_markup) : '',
            'parse_mode' => $parse_mode,
            'entities' => $entities ? json_encode($entities) : '',
            'business_connection_id' => $business_connection_id
        ]);
    }

    //sendlocation methodi qo'shildi
    ...
    public function editMessageCaption($chat_id, $message_id, $caption, $reply_markup=null) {
